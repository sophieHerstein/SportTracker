        ...
        <View style={[globalStyles.cards, globalStyles.row]}>
            <View style={styles.info}>
                ...
                <View style={globalStyles.rowWithoutSpace}>
                    {item.strecke > 0 &&
                        <Text style={[globalStyles.text, globalStyles.light]}>Strecke: {item.strecke}km; </Text>}
                    <Text style={[globalStyles.text, globalStyles.light]}>Zeit: {item.dauer}min</Text>
                </View>
                {item.strecke > 0 && <Text
                    style={[globalStyles.text, globalStyles.light]}>Durchschnittsgeschwindigkeit: {roundTo(item.strecke / (item.dauer / 60), 2)} km/h</Text>}
            </View>
